...
import { ArrowLeft, Calendar, Gauge, Settings, Fuel, Palette, CreditCard } from "lucide-react"
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="mt-2 text-4xl font-bold text-[#8B0000]">{formattedPrice}</p>
              </div>
              ...
              <Card>
                <CardContent className="p-6">
                  <h2 className="mb-4 text-lg font-semibold text-foreground">Especificações</h2>
              ...
              <Card>
                <CardContent className="p-6">
                  <h2 className="mb-2 text-lg font-semibold text-foreground">Observações</h2>
                  <p className="text-muted-foreground">{motorcycle.observations}</p>
                </CardContent>
              </Card>
              ...
              <div className="hidden gap-4 md:flex">
                <Button asChild className="flex-1 bg-[#25D366] text-white hover:bg-[#1fb855]">
                  <a
                    href={`https://wa.me/5511999999999?text=${encodeURIComponent(`Olá! Tenho interesse na ${motorcycleName} - ${formattedPrice}`)}`}
                    target="_blank"
